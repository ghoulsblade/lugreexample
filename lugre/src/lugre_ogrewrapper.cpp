...
bool	cOgreWrapper::CreateOgreWindow		(bool bConfigRestoreOrDialog) { 
	...
	// mRoot->getRenderSystem()->setWaitForVerticalBlank(false);  // ogre1.9 : moved to Ogre::RenderWindow::setVSyncEnabled
	...
	*/
	...
	mWindow->setVSyncEnabled(false); // pre 1.9 = RenderSystem:setWaitForVerticalBlank
