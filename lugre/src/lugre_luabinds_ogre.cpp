...
class cLugreLuaBind_Ogre_VertexData : public cLuaBindDirect<Ogre::VertexData>, public cLuaBindDirectOgreHelper { public:
	virtual void RegisterMethods	(lua_State *L) { PROFILE
		...
		LUABIND_DIRECTWRAP_RETURN_VOID_NAMEADD(																allocateHardwareAnimationElements,					,(ParamInt(L,2),ParamBoolDefault(L,3,true))	);
...
class cLugreLuaBind_Ogre_Skeleton : public cLuaBindDirect<Ogre::Skeleton>, public cLuaBindDirectOgreHelper { public:
	...
	virtual void RegisterMethods	(lua_State *L) { PROFILE
		...
		LUABIND_QUICKWRAP_STATIC(SkeletonManager_load, { 
				try {
					Ogre::ResourcePtr pRes = Ogre::SkeletonManager::getSingleton().load(ParamString(L,1),ParamStringDefault(L,2,Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME));
					return CreateUData(L,(Ogre::Skeleton*)pRes.getPointer()); 
...
class cLugreLuaBind_Ogre_Material : public cLuaBindDirect<Ogre::Material>, public cLuaBindDirectOgreHelper { public:
	virtual void RegisterMethods	(lua_State *L) { PROFILE
		...
		LUABIND_QUICKWRAP_STATIC_TRYCATCH(MaterialManager_load,		{
			Ogre::ResourcePtr pRes = Ogre::MaterialManager::getSingleton().load(ParamString(L,1),ParamStringDefault(L,2,Ogre::ResourceGroupManager::AUTODETECT_RESOURCE_GROUP_NAME));
			return CreateUData(L,(Ogre::Material*)pRes.getPointer() ); 
		});
...
class cLugreLuaBind_Ogre_VertexDeclaration : public cLuaBindDirect<Ogre::VertexDeclaration>, public cLuaBindDirectOgreHelper { public:
	virtual void RegisterMethods	(lua_State *L) { PROFILE
		...
		LUABIND_QUICKWRAP(getAutoOrganisedDeclaration,	{ return CreateUData(L,GetSelf(L).getAutoOrganisedDeclaration(ParamBool(L,2),ParamBool(L,3),ParamBoolDefault(L,4,true))); });
